...
const Header = ({ type }) => {
	...
	//header will contain all the information regarding the destination, date and options and these will be accessed by different pages separately or together payload is imp to return as react should know what information does we want to access
