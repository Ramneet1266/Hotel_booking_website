...
const Hotel = () => {
	...
	//here ("/")[2] is used as there are two things /hotel/3284fdhdgiu where hotel is the first one and next is the id
	...
	//accessing dates from header page
					...
					{open && (
						<div className="slider">
							...
							<div className="sliderWrapper">
								{/* ? means if there is an image array */}
